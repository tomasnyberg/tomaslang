...
impl OpCode {
    pub fn from_u8(byte: u8) -> Self {
        match byte {
            ...
            20 => OpCode::BitNot,
            21 => OpCode::ShiftLeft,
            22 => OpCode::ShiftRight,
            23 => OpCode::HashMap,
            24 => OpCode::DefineGlobal,
            25 => OpCode::GetGlobal,
            26 => OpCode::SetGlobal,
            27 => OpCode::GetLocal,
            28 => OpCode::SetLocal,
            29 => OpCode::GetSemiLocal,
            30 => OpCode::SetSemiLocal,
            31 => OpCode::In,
            32 => OpCode::JumpIfFalse,
            33 => OpCode::JumpIfTrue,
            34 => OpCode::JumpIfNull,
            35 => OpCode::Jump,
            36 => OpCode::Loop,
            37 => OpCode::Call,
            38 => OpCode::Negate,
...
impl Compiler {
    ...
    fn create_rules() -> HashMap<TokenType, ParseRule> {
        ...
        rule(BitAnd,        None,                      Some(Self::binary), Precedence::BitAnd);
        rule(BitOr,         None,                      Some(Self::binary), Precedence::BitOr);
        rule(BitXor,        None,                      Some(Self::binary), Precedence::BitXor);
        rule(BitNot,        Some(Self::unary),         None,               Precedence::None);
        rule(ShiftLeft,     None,                      Some(Self::binary), Precedence::Shift);
        rule(ShiftRight,    None,                      Some(Self::binary), Precedence::Shift);
    ...
    fn unary(&mut self) {
        ...
        match operator {
            ...
            TokenType::BitNot => self.emit_byte(OpCode::BitNot as u8, true),
    ...
    fn emit_operator(&mut self, operator: TokenType) {
        match operator {
            ...
            TokenType::BitAnd => self.emit_byte(OpCode::BitAnd as u8, true),
            TokenType::BitOr => self.emit_byte(OpCode::BitOr as u8, true),
            TokenType::BitXor => self.emit_byte(OpCode::BitXor as u8, true),
            TokenType::ShiftLeft => self.emit_byte(OpCode::ShiftLeft as u8, true),
            TokenType::ShiftRight => self.emit_byte(OpCode::ShiftRight as u8, true),
