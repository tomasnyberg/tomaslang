...
impl Chunk {
    ...
    pub fn disassemble_instruction(&self, offset: usize) -> usize {
        ...
        match instruction {
            ...
            OpCode::Duplicate => self.simple_instruction("DUPLICATE_OP", offset),
            OpCode::Dup2 => self.simple_instruction("DUPLICATE_OP", offset),
            ...
            OpCode::BitAnd => self.simple_instruction("BIT_AND_OP", offset),
            OpCode::BitOr => self.simple_instruction("BIT_OR_OP", offset),
            OpCode::BitXor => self.simple_instruction("BIT_XOR_OP", offset),
            OpCode::BitNot => self.simple_instruction("BIT_NOT_OP", offset),
            OpCode::ShiftLeft => self.simple_instruction("SHIFT_LEFT_OP", offset),
            OpCode::ShiftRight => self.simple_instruction("SHIFT_RIGHT_OP", offset),
            ...
            OpCode::RaiseError => self.simple_instruction("RAISE_ERROR_OP", offset),
